...
import com.roomtrev.dto.PagedResponse;
import com.roomtrev.dto.RoomRequest;
...
public class RoomService {
    ...
    public PagedResponse<RoomResponse> searchRooms(String city, Double minPrice, Double maxPrice,
        ...
        Page<Room> roomPage = normalizedSearch == null
                ? roomRepository.searchRoomsWithoutText(city, minPrice, maxPrice, roomType, pageable)
                : roomRepository.searchRooms(city, minPrice, maxPrice, roomType, normalizedSearch, pageable);
